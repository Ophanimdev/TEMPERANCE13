...
/datum/preferences/proc/SetChoices(mob/user, limit = 14, list/splitJobs = list("Commandant", "Grandmaster", "Hierarch", "Merchant", "Archivist", "Towner", "Grenzelhoft Mercenary", "Beggar", "Prisoner", "Goblin King"), widthPerColumn = 295, height = 620) //295 620
	if(!SSjob)
		return
